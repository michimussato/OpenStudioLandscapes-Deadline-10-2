...
# cd OpenStudioLandscapes
source .venv/bin/activate
openstudiolandscapes clone-feature --repo=https://github.com/michimussato/OpenStudioLandscapes-Deadline-10-2.git --install
deactivate
```
...
# cd OpenStudioLandscapes
source .venv/bin/activate
pip uninstall OpenStudioLandscapes-Deadline-10-2
deactivate
```
...
Last changed: **2026-07-20 11:14:05 UTC**