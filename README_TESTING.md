<!-- TOC -->
* [OpenStudioLandscapes-Deadline-10-2](#openstudiolandscapes-deadline-10-2)
<!-- TOC -->
...
Instead of the [`definitions.py`](src/OpenStudioLandscapes/Deadline_10_2/definitions.py), 
the accompanying [`workspace.yaml`](workspace.yaml) loads 
the [`_definitions_with_upstream_specs.py`](src/OpenStudioLandscapes/Deadline_10_2/_definitions_with_upstream_specs.py) 
which also contains 
